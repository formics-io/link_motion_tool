...
class LinkMotionToolApp extends StatefulWidget {
  ...
  @override
  _LinkMotionToolAppState createState() => _LinkMotionToolAppState();
}

class _LinkMotionToolAppState extends State<LinkMotionToolApp>{
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: widget.softwareConfigPath.isNotEmpty &&
              widget.softwarePath.isNotEmpty &&
              widget.configFileListCount > 0
